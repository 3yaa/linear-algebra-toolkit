...
class App(Tk):
    def __init__(self):
        ...
        self.operations = {
            ...
            "lu": {"v": "LU Decomposition", "is": False, "need_square": False, "function": lu_decomposition},
            "qr": {"v": "QR Decomposition", "is": False, "need_square": False, "function": qr_decomposition},
    ...
    def main_page(self):
        ...
        #transpose
        self.transpose_button = Button(self, text="Transpose", 
        ...
        #determinant
        self.determinant_button = Button(self, text="Determinant", 
                                         command=lambda: (self.check_operation("d"), self.matrix_setup()), 
                                         width=25, height=3, 
                                         font=("Helvetica", 12, "bold"),
                                         bg="grey", fg="black")
        self.determinant_button.pack(pady=5)
        #inverse
        ...
        #eigenvalue
        self.eigen_button = Button(self, text="Eigenvalue", 
        ...
        # lu and qr
        lu_qr_frame = Frame(self, bg='#202020')
        lu_qr_frame.pack(pady=5)
        #lu
        self.lu_button = Button(lu_qr_frame, text="LU", 
                                command=lambda: (self.check_operation("lu"), self.matrix_setup()),
                                width=11, height=3, 
                                font=("Helvetica", 12, "bold"),
                                bg="grey", fg="black")
        self.lu_button.pack(side=LEFT, padx=3)
        #qr
        self.qr_button = Button(lu_qr_frame, text="QR", 
                                command=lambda: (self.check_operation("qr"), self.matrix_setup()),
                                width=11, height=3, 
                                font=("Helvetica", 12, "bold"),
                                bg="grey", fg="black")
        self.qr_button.pack(side=RIGHT, padx=3)
        # AX=b 
        self.problem_button = Button(self, text="AX = b", 
                                     ...
                                     font=("Helvetica", 12, "bold"),
                                     bg="grey", fg="black")
        self.problem_button.pack(pady=5)
    ...
    def print_result(self):
        ...
        if self.run_operation["v"] == "LU Decomposition" or self.run_operation["v"] == "QR Decomposition":
